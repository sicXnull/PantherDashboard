...
3. Type the following command: wget https://raw.githubusercontent.com/sicXnull/PantherDashboard/php8/install.sh -O - | sudo bash
...
## Contribute ##
If you find some issues or problems when you use the dashboard. you are always welcome to submit the issue here: https://github.com/sicXnull/PantherDashboard/issues
